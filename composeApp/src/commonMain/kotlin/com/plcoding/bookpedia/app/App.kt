        ...
        NavHost(
            ...
            navigation<Route.BookGraph>(
                ...
                composable<Route.BookList>(
                    ...
                    // for example: from detailScreen pop to back screen (this screen, BookList)
...
// this function return the same viewModel because the viewmodel is tied to a specific graph.
// Both screens (e.g., BookList and BookDetail) are inside this graph,
// so they share the same parent graph (NavBackStackEntry).
@Composable
